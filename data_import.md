...
I want to import the file ‘FSA\_litters.csv’.
...
Yay! I imported the dataset. Now I want better variables names,
preferably in snake case.
...
One Jeff uses a lot to view litters\_df in new window you can scroll
through without any output:
